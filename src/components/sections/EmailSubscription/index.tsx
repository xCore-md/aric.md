...
export const EmailSubscriptionSection: React.FC<{ withBg?: boolean }> = ({
  ...
  return (
    <section className="py-24 -mb-28 relative">
      <div className="container relative z-10">
        <div className="grid grid-cols-2 gap-32">
          ...
          <div className="relative flex">
            <svg
              className="fill-back/90 absolute h-44 -top-36 -left-5"
              viewBox="0 0 339 213"
            >
            ...
            <form action="" className="w-full mt-auto">
              <div className="w-full flex items-center gap-5">
                <Input
                  placeholder="Adresa ta de e-mail"
                  className="bg-white/14 placeholder:text-platinum border-transparent"
                />
                <Button>Abonează-te</Button>
              </div>
            </form>
